...
This repository will be updated to contain the exercises and solutions.

Course website: <https://www.ph.nat.tum.de/cmt/teaching/computational-methods/>

Moodle: <https://www.moodle.tum.de/course/view.php?id=116136>

Git repository: <https://gitlab.lrz.de/cmt-computational-physics/tutorials_2026>
...
4. On the cip pools, open a Terminal, and enter
```bash
source /mount/packs/ml-noble/bin/activate
jupyter lab
```
...
## Automatically graded notebooks

We will use (<https://nbgrader.readthedocs.io/en/stable/>) to automatically grade parts of your solutions. For an introduction to nbgrader, see Exercise 0.1.
